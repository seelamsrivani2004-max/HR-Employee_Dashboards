                            ...
                            <div style={{ maxHeight: '220px', overflowY: 'auto', border: '1px solid #e2e8f0', borderRadius: '0.5rem', padding: '0.5rem' }}>
                                {employees.length === 0 ? (
                                    ...
                                    <label key={emp.id} style={{
                                        ...
                                        background: selectedIds.includes(emp.id) ? '#eef2ff' : 'transparent'
                                    }}
                                        onMouseEnter={e => { if (!selectedIds.includes(emp.id)) e.currentTarget.style.background = '#f8fafc'; }}
                                        onMouseLeave={e => { e.currentTarget.style.background = selectedIds.includes(emp.id) ? '#eef2ff' : 'transparent'; }}>
