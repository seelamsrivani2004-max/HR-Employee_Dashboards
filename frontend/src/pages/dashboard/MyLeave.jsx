                ...
                {loading ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {history.map(leave => {
                            ...
                            return (
                                <div key={leave.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.85rem 1rem', background: '#f8fafc', borderRadius: '0.5rem', flexWrap: 'wrap', gap: '0.75rem' }}>
