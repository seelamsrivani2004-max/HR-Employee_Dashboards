...
const menuItems = [
    ...
    { to: '/dashboard/my-tasks', icon: <CheckSquare size={20} />, label: 'My Tasks', roles: ['Employee', 'Teamlead', 'HR', 'Admin'] },
    { to: '/dashboard/my-leave', icon: <Calendar size={20} />, label: 'My Leave', roles: ['Employee', 'Teamlead', 'HR', 'Admin'] },
    { to: '/dashboard/my-attendance', icon: <Clock size={20} />, label: 'My Attendance', roles: ['Employee', 'Teamlead', 'HR', 'Admin'] },
    { to: '/dashboard/my-project', icon: <Rocket size={20} />, label: 'My Project', roles: ['Employee', 'Teamlead', 'HR', 'Admin'] },
    // Teamlead-specific
